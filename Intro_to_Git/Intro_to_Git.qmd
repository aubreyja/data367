...
These approaches do not scale well. They make it difficult to answer basic questions such as: - Who made this change? - When was it made? - Which version is the most recent? - How do we combine changes made by different people?
...
If Git is installed, you will see a version number. If you see an error instead, Git needs to be installed.

General installation guidance by operating system:

-   **macOS**

    Git can be installed by installing the Xcode Command Line Tools or via Homebrew

-   **Windows**

    Install *Git for Windows*, which includes both Git and a terminal environment.

-   **Linux**

    Install Git using your system’s package manager.

Links to detailed installation instructions are provided in the references section.
...
Instead, GitHub Classroom works by giving you a structured GitHub repository and expecting you to use Git in a disciplined way throughout the assignment.
...
## Getting work from your computer to GitHub (command line)
...
A **commit** saves a snapshot of the staged changes and records them in the repository history.
...
## Getting work from your computer to GitHub (Positron)
